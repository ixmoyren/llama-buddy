use crate::error::{
    ApplyChatTemplateError, ChatTemplateError, LlamaAdapterLoraInitError, LlamaContextLoadError,
    StringConversionError, TokenConversionError,
};
use crate::model::{AdapterLora, chat};
...
impl Model {
    ...
    fn get_chat_template_impl(&self, capacity: usize) -> Result<chat::Template, ChatTemplateError> {
    ...
    pub fn get_chat_template(&self) -> Result<chat::Template, ChatTemplateError> {
